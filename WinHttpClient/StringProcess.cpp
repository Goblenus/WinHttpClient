...
inline wstring URLEncoding(const wstring &keyword, bool convertToUTF8)
{
	int iLength = 0;
	char *szKeyword = NULL;
...
inline wstring GetDateString(const COleDateTime &time, const wstring &separator, bool align)
{
	wstring date = L"";
...
inline wstring GetDateString(int dayOffset, const wstring &separator, bool align)
{
...
inline wstring GetTimeString(const COleDateTime &time, const wstring &separator, bool align)
{
	wstring date = L"";
	wchar_t szTemp[MAX_PATH] = L"";
